...
from OS X or Windows, though on Windows the process is [less smooth right now][lsrt].

[lsrt]: https://gist.github.com/brson/a2b97ba8b3fbb7939143f584b6366751
...
Android. To develop for Android we need the [Andoid NDK]. It contains
